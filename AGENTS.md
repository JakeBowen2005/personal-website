...
**AI/APIs**
- Anthropic Codex API, Google Places API, Server-Sent Events (SSE)
...
**What It Is**
- Co-founded and sole-developed production SaaS platform
...
**Customer Focus**
- Co-founder partner (Ricky) handles sales/outreach
